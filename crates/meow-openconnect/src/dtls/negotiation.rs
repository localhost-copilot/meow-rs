...
impl Offer {
    ...
    pub(crate) fn headers(&self) -> Zeroizing<String> {
        const CIPHERS: &str = "PSK-NEGOTIATE:OC2-DTLS1_2-CHACHA20-POLY1305:OC-DTLS1_2-AES256-GCM:OC-DTLS1_2-AES128-GCM";
        let mut headers = Zeroizing::new(format!("X-DTLS-CipherSuite: {CIPHERS}\r\nX-DTLS12-CipherSuite: {CIPHERS}\r\nX-DTLS-Accept-Encoding: identity\r\nX-DTLS-Master-Secret: "));
...
impl Headers {
    ...
    pub(crate) fn negotiate(
        ...
        for name in ["x-dtls-content-encoding", "x-dtls12-content-encoding"] {
            if self.0.get(name).is_some_and(|v| v != "identity") {
                return Err(invalid("DTLS compression unsupported"));
            }
        }
        ...
        let key = if cipher == "PSK-NEGOTIATE" {
            ...
            let cipher = match cipher {
                ...
                "OC2-DTLS1_2-CHACHA20-POLY1305" => Cipher::Chacha20Poly1305,
                _ => {
