...
fn invalid_or_unimplemented_options_are_not_silently_accepted() {
    for extra in [
        ...
        "queue-length: 4097",
        "base-mtu: 575",
        "dtls-key-exchange: psk",
        "dtls-local-port: 65536",
        "reported-os: invalid-os",
        "mobile: {device-type: phone}",
        "form-entries: [{name: otp, value: fixture}]",
        "form-entries: [{form-id: login, name: otp, promote: true, value: fixture}]",
        "peer-fingerprint: not-a-fingerprint",
        "peer-fingerprint: sha256:abcd\nskip-cert-verify: true",
