...
- **OpenConnect / AnyConnect** -- Cookie-authenticated CSTP/TLS with IPv4 TCP/UDP (`openconnect` opt-in feature; [configuration and current limits](docs/openconnect.md))
